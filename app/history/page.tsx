...
export default function HistoryPage() {
  ...
  useEffect(() => { fetch('/api/inventory').then(r=>r.json()).then(d=>setSales(d.sales||[])) }, [])
      ...
      <div style={{border:'1px solid var(--border)',borderRadius:12,overflow:'auto'}}>
        <table style={{width:'100%',borderCollapse:'collapse',fontSize:13}}>
          ...
          <tbody>
            ...
            {sales.length===0&&<tr><td colSpan={5} style={{...s.td,textAlign:'center',color:'var(--muted)',padding:32}}>販売記録がありません</td></tr>}
          </tbody>
        </table>
      </div>
    </AppShell>
